...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Raleway:300,400,600,700,900|Roboto:300,400,500,900&display=swap"
    rel="stylesheet">
    ...
    @endif
      <div class="ui middle aligned grid container">
        <div class="four wide column">
          @if (Request::is('/'))
          <a href="/"><img src="{{URL::asset('images/uniqueflirt-logo.png')}}" height="46" width="auto"
              alt="UniqueFlirt" /></a>
          @else
          <a href="/"><img src="{{URL::asset('images/uniqueflirt-logo-1.png')}}" height="46" width="auto"
              alt="UniqueFlirt" /></a>
          @endif
        </div>
              ...
              <ul>
                ...
                <!-- <li>
                  <div class="ui selection dropdown">
                    ...
                    <div class="menu">
                      <div class="item" data-value="en"><a href="/language/en"><i class="gb uk flag"></i>English</a>
                      </div>
                      ...
                      <div class="item" data-value="fr"><a href="/language/fr"><i class="france flag"></i>French</a>
                      </div>
                    </div>
                  </div>
                </li> -->
                ...
                <li>
                  <div class="ui selection dropdown">
                    ...
                    <div class="menu" style="min-width: 200px; max-height: 600px;">
                      ...
                      <hr style="border-style: ridge;" />
                      <div class="item"><a href="/myprofile"><i class="fas fa-user"></i> {{Auth::user()->name}}</a>
                      </div>
                      <hr style="border-style: ridge;" />
        ...
        <div class="register-info">
          <img class="u1 parallax" data-offset="20" src="{{URL::asset('images/left-profile-1.png')}}"
            alt="Profile Image" />
          <img class="u2 parallax" data-offset="76" src="{{URL::asset('images/left-profile-2.png')}}"
            alt="Profile Image" />
          <img class="u3 parallax" data-offset="37" src="{{URL::asset('images/left-profile-3.png')}}"
            alt="Profile Image" />
          <img class="u4 parallax" data-offset="18" src="{{URL::asset('images/left-profile-4.png')}}"
            alt="Profile Image" />
          <img class="u5 parallax" data-offset="79" src="{{URL::asset('images/left-profile-5.png')}}"
            alt="Profile Image" />
          <img class="i1 parallax" data-offset="110" src="{{URL::asset('images/left-icon-1.png')}}"
            alt="Profile Icon" />
          ...
          <img class="u6 parallax" data-offset="23" src="{{URL::asset('images/right-profile-1.png')}}"
            alt="Profile Image" />
          <img class="u7 parallax" data-offset="65" src="{{URL::asset('images/right-profile-2.png')}}"
            alt="Profile Image" />
          <img class="u8 parallax" data-offset="99" src="{{URL::asset('images/right-profile-3.png')}}"
            alt="Profile Image" />
          <img class="u9 parallax" data-offset="118" src="{{URL::asset('images/right-profile-4.png')}}"
            alt="Profile Image" />
          <img class="u10 parallax" data-offset="47" src="{{URL::asset('images/right-profile-5.png')}}"
            alt="Profile Image" />
          <img class="i4 parallax" data-offset="28" src="{{URL::asset('images/right-icon-1.png')}}"
            alt="Profile Icon" />
          <img class="i5 parallax" data-offset="87" src="{{URL::asset('images/right-icon-2.png')}}"
            alt="Profile Icon" />
          <img class="i6 parallax" data-offset="19" src="{{URL::asset('images/right-icon-3.png')}}"
            alt="Profile Icon" />
          <img class="i7 parallax" data-offset="74" src="{{URL::asset('images/right-icon-4.png')}}"
            alt="Profile Icon" />
          <div class="ui grid centered middle aligned container stackable">
            <div class="ten wide column">
              <div class="info-text">
                <h2>More Flirts meets singles</h2>
                <p>Our mission is to provide the best technology for people to meet, because happiness is better
                  shared.
                </p>
              </div>
    ...
    <footer>
      <div class="ui grid center aligned container stackable">
        <div class="sixteen wide column">
          <a class="logo-footer" href="/"><img src="{{URL::asset('images/uniqueflirt-logo-1.png')}}" height="46"
              width="auto" alt="UniqueFlirt" /></a>
      ...
      <div class="ui grid center aligned container stackable">
        <div class="sixteen wide column">
          <div class="logo-links">
            <a href="https://customer.centralpay.net/home/736523b3-437f-45cf-897b-f1fdfa183a07" target="_blank"><img
                src="{{URL::asset('images/central-pay-logo.png')}}" title="Central Pay" alt="Central Pay"></a>
          </div>
